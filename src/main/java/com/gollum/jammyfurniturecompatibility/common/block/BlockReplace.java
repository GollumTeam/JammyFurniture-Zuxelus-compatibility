package com.gollum.jammyfurniturecompatibility.common.block;
...
public class BlockReplace extends HBlockContainer {
	
	public static class ReplaceBlock implements Cloneable {
		...
		public static ReplaceBlock get(BlockReplace proxy) {
			return get(proxy, 0);
		}
		...
		public static ReplaceBlock get(Block b, int metadata) {
			...
			BlockReplace proxy = (BlockReplace) b;
	...
	public BlockReplace(String modId, String registerName, ReplaceBlock target) {
	...
	public BlockReplace(String modId, String registerName, ReplaceBlock[] targets) {
	...
	public void register () {
		...
		GameRegistry.registerBlock (this, ItemBlockReplace.class, getRegisterName ());
	...
	protected ItemStack createStackedBlock(int metadata) {
		...
		ReplaceBlock t = ReplaceBlock.get(this, metadata);
		try {
			Method m = Reflection.getObfuscateMethod(t.getBlock().getClass(), BlockReplace.class, "createStackedBlock");
	...
	protected void dropBlockAsItem(World w, int x, int y, int z, ItemStack p_149642_5_) {
		...
		try {
			Method m = Reflection.getObfuscateMethod(b.getClass(), BlockReplace.class, "dropBlockAsItem");
			m.setAccessible(true);
	...
	protected boolean canSilkHarvest() {
		Block b = ReplaceBlock.get(this).getBlock();
		try {
			Method m = Reflection.getObfuscateMethod(b.getClass(), BlockReplace.class, "canSilkHarvest");
			m.setAccessible(true);
	...
	protected String getTextureName() {
		...
		try {
			Method m = Reflection.getObfuscateMethod(t.getBlock().getClass(), BlockReplace.class, "getTextureName");
			m.setAccessible(true);
